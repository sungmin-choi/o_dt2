...
const Introduce = () => {
    ...
    return (
        <section className={styles.introduce}>
            {showImageZone && (
                <ImagesZoom onClose={onClose} currentImage={currentImage} />
            )}
            <p className={styles.title}>
                <span className={styles.logoName}>{`o'dt`}</span>&nbsp;으로
                오세요!
            </p>
            <button className={styles.rsBtn}>
                <a
                    ...
                    href="https://search.naver.com/search.naver?where=nexearch&sm=top_sly.hst&fbm=1&acr=1&ie=utf8&query=%EA%B0%95%EB%AC%B8+%EC%98%A4%EB%93%AF"
                    target="_blank"
                >
                    <span
                        style={{
            ...
            <article className={styles.detail}>
                <div className={styles.address}>
                    <h2>주소</h2> 강릉시 창해로 <br />
                    350번길21-1 오듯
                    <br /> namja306@naver.com
                </div>
                <div className={styles.openTime}>
                    <h2>영업시간</h2> 월-일 12:00-24:00
                    <br />
                    수요일 휴무{' '}
                </div>
            </article>
